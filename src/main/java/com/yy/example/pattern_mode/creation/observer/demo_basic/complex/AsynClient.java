package com.yy.example.pattern_mode.creation.observer.demo_basic.complex;

import com.yy.example.pattern_mode.creation.observer.demo_basic.Observer;
import com.yy.example.pattern_mode.creation.observer.demo_basic.Subject;
 ...
 *
 *     而手动通知的方式见{@link com.yy.example.pattern_mode.creation.observer.demo_basic.Client}
 * </pre>
 * NB.
...
public class AsynClient {
    ...
    /**
     * <pre>
     * 48行 通过匿名类的方式定义一个观察者并调用attach方法(临时)注册到被观察者上，由于attach()方法实现：
     ...
     *    }
     * }
     * 所以会调用onAttach.call(this, observer)方法，而其实现为：
     * 45行通过匿名类调用观察者update方法

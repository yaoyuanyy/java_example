...
public class ThreadPoolExecutorTest1 {
    ...
    public static void main(final String[] args) {
        ...
        final ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(3, 10, 60 * 10, TimeUnit.SECONDS,
                new LinkedBlockingDeque(5),
                new BasicThreadFactory.Builder().namingPattern("test-thread-%d").build(),

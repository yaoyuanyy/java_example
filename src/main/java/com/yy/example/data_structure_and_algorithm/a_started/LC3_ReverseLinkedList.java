 ...
 * </pre>
 */
public class LC3_ReverseLinkedList {
    ...
    public ListNode reverseList(ListNode head) {
        ...
        // 此时，pre = cur; cur = null，代码执行到这里时，pre指向最后一个节点，此时它已成为链表的头节点
        return pre;
    }
     ...
     * 空间复杂度O(n)
     *
     * https://leetcode.cn/problems/reverse-linked-list/solution/fan-zhuan-lian-biao-by-leetcode-solution-d1k2/ 参考 NoColor96
     * @param head
     * @return
     */
    ...
    public ListNode reverseList5(ListNode head) {
        ...
        for (; head !=null; head = head.next) {
            // cur -> dummy;
            ListNode cur = new ListNode(head.val, dummy);
            dummy = cur;
        }
        return dummy;
    }
    ...
    public static void main(String[] args) {
        LC3_ReverseLinkedList reverseLinkedList = new LC3_ReverseLinkedList();
        // 1 -> 2 -> 3 -> 4 -> 5

 ...
 */
public class LC34_SearchRepeatFirstAndLastOfArray {
    ...
    public static void main(String[] args) {
        ...
        int target = 6;
        int first = new LC34_SearchRepeatFirstAndLastOfArray().binarySearch2(arr, target);
        System.out.println("first:" + first);

        int last = new LC34_SearchRepeatFirstAndLastOfArray().binarySearch3(arr, target);

 ...
 *
 * 具体下问题
 * 假如：基本收税是2200元。进一档加500元，税率分为n挡，分别为0.14，0.15，0.16，0.17，0.18 ... n。求输入任一收税金额，输出相应的税是多少
 *    收税金额         税
 *     0 - 2200           2200*0
 *     2200 - 2700           (x-2200)*0.14
 *     2700 - 3200           (x-2700)*0.15 + (2700-2200)*0.14 = (x-2700)*0.15 + 70
 *     3200 - 3700           (x-3200)*0.16 + (2700-2200)*0.15 + (2700-2200)*0.14 = (x-2700)*0.16 + 75 + 70
 *     3700 - 4200           (x-3700)*0.17 + (3200-2700)*0.16 + (2700-2200)*0.15 + (2700-2200)*0.14 = (x-2700)*0.17 + 80 + 75 + 70
 *     ...            ...
 *
...
public class Test_3_7_1 {
    ...
    public double getTaxOf(double salary) {
        int index = ((int)salary - 2200) / 500;
        if(index < 0 || salary <= 2200) {
